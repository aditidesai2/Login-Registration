...
public class ValidationImplementation implements IValidation {
	...
	public boolean isValidatingEmail(String inputEmail) {
		String emailValidationQuery = "select email from register where email = ?";
	...
	public boolean isValidatingPhoneNumber(String inputNumber) {
		String phoneNumberValidationQuery = "select mobileNumber from register where mobileNumber = ?";
		conn = DBConnection.getConnection();
		try {
	...
	public boolean isValidatingUserName(String userName) {
		String userNameValidationQuery = "select userName from register where userName = ?";
		conn = DBConnection.getConnection();
		try {
